...
| 포인트 | 약어 | 설명 | 획득 방법 | 사용처 |
| :--- | :--- | :--- | :--- | :--- |
| **Game Point** | **GP** | 게임 활동으로 획득하는 **누적 포인트**. 소비 불가. | 셀 획득 **+1**, 빙고줄 **+20/+40/+60**, 챌린지 공격 **+10**, 방어 **+5**, 승리 **+50** | 프로필 누적 통계 (향후 랭킹/칭호 확장) |
| **Value Point** | **VP** | **현금 구매** 또는 **보상형 광고**로 획득. | IAP 구매, 보상형 광고 시청 **+5 VP** (일일 최대 10회) | 광고 제거 (**200 VP**/게임, **8,000 VP**/영구) |
